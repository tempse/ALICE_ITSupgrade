...
int TMVAClassification_singleTrackTree( TString myMethodList = "" )
{
   ...
   TString fname = "../FT2_AnalysisResults_Upgrade_addFeat_part1_1-1-8-split.root";
   ...
   // dataloader->AddSpectator( "pdg" );
   // dataloader->AddSpectator( "pdgMother" );
   // dataloader->AddSpectator( "pdgFirstMother" );
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
					   "!V:SplitMode=Random:nTest_Signal=5000:nTest_Background=5000" );
   ...
   if (Use["BDT"])  // Adaptive Boost
      factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT",
                           "!H:!V:NTrees=600:MinNodeSize=2.5%:MaxDepth=4:BoostType=AdaBoost:AdaBoostBeta=0.05:UseBaggedBoost:BaggedSampleFraction=0.6:SeparationType=GiniIndex:nCuts=20:VarTransform=N" );
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_singleTrackTree(methodList);
}
