...
{   
  ...
  if(gROOT->GetVersion() == problematicRootVersion) {
   ...
   // TString fname = "../../../trainingPhase2/pairedTrackTree/FT2_AnalysisResults_Upgrade_addFeat_partialTagging_pairtree_us_part2_1-1-8-split.root";
   ...
   for (Long64_t ievt=0; ievt<nIevt;ievt++) {
      ...
      var_mass = app_mass;
      //var_pz_diff = TMath::Abs(app_pz1/TMath::Sqrt(app_px1*app_px1+app_py1*app_py1)-app_pz2/TMath::Sqrt(app_px2*app_px2+app_py2*app_py2));
      //var_sumz = app_sumz;
      //var_diffz = TMath::Abs(app_diffz-1.57);
      var_opang = app_opang;
      //var_nITS1 = app_nITS1;
      //var_nITS2 = app_nITS2;
      //var_nITSshared1 = TMath::Abs(app_nITSshared1);
      //var_nITSshared2 = TMath::Abs(app_nITSshared2);
      //var_nTPC1 = TMath::Abs(app_nTPC1);
      //var_nTPC2 = TMath::Abs(app_nTPC2);
      ...
      //var_ITSchi21 = TMath::Abs(app_ITSchi21);
      //var_ITSchi22 = TMath::Abs(app_ITSchi22);
      //var_TPCchi21 = TMath::Abs(app_TPCchi21);
      //var_TPCchi22 = TMath::Abs(app_TPCchi22);
      //var_pt1 = app_pt1;
      //var_pt2 = app_pt2;
      //var_eta1 = app_eta1;
      //var_eta2 = app_eta2;
	...
	BDT = 1; // no RP conversions at high mass values
      }
      // bMLP->Fill();
      targetTree->Fill();
