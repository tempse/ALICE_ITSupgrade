...
int TMVAClassification_pairTree( TString myMethodList = "" )
{
   ...
   TFile *infile = TFile::Open("../FT2_AnalysisResults_Upgrade_addFeat_noPrefilterVars_pairtree_us_part1_1-1-8-split.root");
...
TCut signalCut = "!(IsRP==1 && IsConv==1)"; // how to identify signal events
TCut backgrCut = "IsRP==1 && IsConv==1"; // how to identify background events  
...
//       factory->PrepareTrainingAndTestTree( mycut,       "NTrain_Signal=3751:NTrain_Background=52925:NTest_Signal=0:NTest_Background=0:SplitMode=Random:!V" );
   ...
   if (Use["MLP"])
      factory->BookMethod( dataloader, TMVA::Types::kMLP, "MLP", "!H:!V:NeuronType=tanh:VarTransform=N:ConvergenceTests=50:NCycles=500:HiddenLayers=15,15,15,15:UseRegulator" );
   ...
   if (Use["BDTG"]) // Gradient Boost
    ...
    if (Use["BDT"])  // Adaptive Boost
      factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT",
                           "!H:!V:NTrees=600:MinNodeSize=1%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.05:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20:VarTransform=N" );
