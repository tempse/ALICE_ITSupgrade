...
//   TCut mycutb = ""; // for example: TCut mycutb = "abs(var1)<0.5";
   TCut mycut = "mass>.1 && IsTaggedConvTrack1==0 && IsTaggedConvTrack2==0";
//   TCut mycut = "";
   ...
   if (Use["BDTG"]) // Gradient Boost
    ...
    if (Use["BDT"])  // Adaptive Boost
      factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT",
                           "!H:!V:NTrees=600:MinNodeSize=5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.05:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20:VarTransform=N" );
