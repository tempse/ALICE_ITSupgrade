...
//   TCut mycutb = ""; // for example: TCut mycutb = "abs(var1)<0.5";
   TCut mycut = "mass>.1 && IsTaggedRPConv_MVAcuts_prefilter==0";
//   TCut mycut = "";
...
//       factory->PrepareTrainingAndTestTree( mycut,       "NTrain_Signal=3751:NTrain_Background=52925:NTest_Signal=0:NTest_Background=0:SplitMode=Random:!V" );
   ...
   if (Use["MLP"])
      factory->BookMethod( dataloader, TMVA::Types::kMLP, "MLP", "!H:!V:NeuronType=tanh:VarTransform=N:ConvergenceTests=50:NCycles=500:HiddenLayers=N,N,N,N,N:!UseRegulator" );
   ...
   if (Use["BDTG"]) // Gradient Boost
    ...
    if (Use["BDT"])  // Adaptive Boost
      factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT",
                           "!H:!V:NTrees=300:MinNodeSize=2.5%:MaxDepth=4:BoostType=AdaBoost:AdaBoostBeta=0.1:UseBaggedBoost:BaggedSampleFraction=0.6:DoBoostMonitor:SeparationType=GiniIndex:nCuts=20:VarTransform=N" );
